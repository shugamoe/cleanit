...
muSigmaPB <- dataPB %>%
  ...
  mutate(n = factor(n, levels = sort(unique(.$n))),
         normmuMedian = median(normmu),
         normsigmaMedian = median(normsigma),
         normsigmasqrMedian = median(normsigmasqr)
         )
...
(ggplot(muSigmaPB) +
  ...
  labs(title = "Distribution of normmu (Fall12 Only, Median Plotted)", subtitle = "Price Beliefs Data") +
  theme_minimal() +
  facet_grid(group ~ .) +
  geom_vline(aes(xintercept = normmuMedian), linetype = "dotted") +
  theme(strip.text.y = element_text(angle = 0, hjust = 1))
)

(ggplot(muSigmaPB) +
  geom_density(aes(normsigma, fill = n)) +
  labs(title = "Distribution of normsigma (Fall12 Only, Median Plotted)", subtitle = "Price Beliefs Data") +
  theme_minimal() +
  facet_grid(group ~ .) +
  geom_vline(aes(xintercept = normsigmaMedian), linetype = "dotted") +
  theme(strip.text.y = element_text(angle = 0, hjust = 1))
)

(ggplot(muSigmaPB) +
  geom_density(aes(normsigmasqr, fill = n)) +
  labs(title = "Distribution of normsigmasqr (Fall12 Only, Median Plotted)", subtitle = "Price Beliefs Data") +
  theme_minimal() +
  facet_grid(group ~ .) +
  geom_vline(aes(xintercept = normsigmasqrMedian), linetype = "dotted") +
  theme(strip.text.y = element_text(angle = 0, hjust = 1))
)

(ggplot(muSigmaJoined) +
  geom_density(aes(normmu, fill = n)) +
  labs(title = "Distribution of normmu (Fall12 Only, Median Plotted)", subtitle = "Loose Joined Data") +
  theme_minimal() +
  facet_grid(group ~ .) +
  geom_vline(aes(xintercept = normmuMedian), linetype = "dotted") +
  theme(strip.text.y = element_text(angle = 0, hjust = 1))
...
(ggplot(arrange(muSigmaJoined, n)) +
  geom_density(aes(normsigma, fill = n)) +
  labs(title = "Distribution of normsigma (Fall12 Only, Median Plotted)", subtitle = "Loose Joined Data") +
  theme_minimal() +
  geom_vline(aes(xintercept = normsigmaMedian), linetype = "dotted") +
  facet_grid(group ~ .) +
  theme(strip.text.y = element_text(angle = 0, hjust = 1))
...
(ggplot(arrange(muSigmaJoined, n)) +
  geom_density(aes(normsigmasqr, fill = n)) +
  labs(title = "Distribution of normsigmasqr (Fall12 Only, Median Plotted)", subtitle = "Loose Joined Data") +
  theme_minimal() +
  geom_vline(aes(xintercept = normsigmasqrMedian), linetype = "dotted") +
  facet_grid(group ~ .) +
  theme(strip.text.y = element_text(angle = 0, hjust = 1))
...
(ggplot(muSigmaPB) +
  ...
  labs(title = "Histogram of normmu (Fall12 Only, Median Plotted)", subtitle = "Price Beliefs Data | Binwidth = .1") +
  theme_minimal() +
  geom_vline(aes(xintercept = normmuMedian), linetype = "dotted") +
  facet_grid(group ~ .) +
  theme(strip.text.y = element_text(angle = 0, hjust = 1))
...
(ggplot(muSigmaPB) +
  ...
  labs(title = "Histogram of normsigma (Fall12 Only, Median Plotted)", subtitle = "Price Beliefs Data | Binwidth = .1") +
  geom_vline(aes(xintercept = normsigmaMedian), linetype = "dotted") +
  theme_minimal() +
  facet_grid(group ~ .) +
  theme(strip.text.y = element_text(angle = 0, hjust = 1))
...
(ggplot(muSigmaPB) +
  ...
  labs(title = "Histogram of normsigmasqr (Fall12 Only, Median Plotted)", subtitle = "Price Beliefs Data | Binwidth = .1") +
  geom_vline(aes(xintercept = normsigmasqrMedian), linetype = "dotted") +
  theme_minimal() +
  facet_grid(group ~ .) +
  theme(strip.text.y = element_text(angle = 0, hjust = 1))
...
(ggplot(muSigmaJoined) +
  geom_histogram(aes(normmu, fill = n), binwidth = .1) +
  labs(title = "Histogram of normmu (Fall12 Only, Median Plotted)", subtitle = "Loose Joined Data | Binwidth = .1") +
  geom_vline(aes(xintercept = normmuMedian), linetype = "dotted") +
  theme_minimal() +
  facet_grid(group ~ .) +
  theme(strip.text.y = element_text(angle = 0, hjust = 1))
...
(ggplot(arrange(muSigmaJoined, n)) +
  geom_histogram(aes(normsigma, fill = n), binwidth = .1) +
  labs(title = "Histogram of normsigma (Fall12 Only, Median Plotted)", subtitle = "Loose Joined Data | Binwidth = .1") +
  geom_vline(aes(xintercept = normsigmaMedian), linetype = "dotted") +
  theme_minimal() +
  facet_grid(group ~ .) +
  theme(strip.text.y = element_text(angle = 0, hjust = 1))
...
(ggplot(arrange(muSigmaJoined, n)) +
  geom_histogram(aes(normsigmasqr, fill = n), binwidth = .1) +
  labs(title = "Histogram of normsigmasqr (Fall12 Only, Median Plotted)", subtitle = "Loose Joined Data | Binwidth = .1") +
  geom_vline(aes(xintercept = normsigmasqrMedian), linetype = "dotted") +
  theme_minimal() +
  facet_grid(group ~ .) +
  theme(strip.text.y = element_text(angle = 0, hjust = 1))
