...
(ggplot(muSigmaPB) +
  ...
  labs(title = "Distribution of normmu", subtitle = "Price Beliefs Data") +
  theme_minimal() +
  facet_wrap(group ~ .)
)
...
(ggplot(muSigmaPB) +
  ...
  labs(title = "Distribution of normsigma", subtitle = "Price Beliefs Data") +
  theme_minimal() +
  facet_wrap(group ~ .)
)
...
(ggplot(muSigmaJoined) +
  ...
  theme_minimal() +
  facet_wrap(freshPB ~ treatControl)
)

(ggplot(arrange(muSigmaJoined, n)) +
  geom_density(aes(normsigma, fill = n)) +
  labs(title = "Distribution of normsigma", subtitle = "Loose Joined Data") +
  theme_minimal() +
  facet_wrap(freshPB ~ treatControl)
)
...
(ggplot(muSigmaPB) +
  ...
  labs(title = "Histogram of normmu", subtitle = "Price Beliefs Data | Binwidth = .1") +
  theme_minimal() +
  facet_wrap(group ~ .)
)
...
(ggplot(muSigmaPB) +
  ...
  labs(title = "Histogram of normsigma", subtitle = "Price Beliefs Data | Binwidth = .1") +
  theme_minimal() +
  facet_wrap(group ~ .)
)
...
(ggplot(muSigmaJoined) +
  geom_histogram(aes(normmu, fill = n), binwidth = .1) +
  labs(title = "Histogram of normmu", subtitle = "Loose Joined Data | Binwidth = .1") +
  theme_minimal() +
  facet_wrap(freshPB ~ treatControl)
)
...
(ggplot(arrange(muSigmaJoined, n)) +
  geom_histogram(aes(normsigma, fill = n), binwidth = .1) +
  labs(title = "Histogram of normsigma", subtitle = "Loose Joined Data | Binwidth = .1") +
  theme_minimal() +
  facet_wrap(freshPB ~ treatControl)
)
```
