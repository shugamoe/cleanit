...
# Summary Statistics Plot for Clean Sample Data 

## General Treatment Breakdown
```{r, include=TRUE}
createTreatmentPlot(dataCS)
```

## Treatment Breakdown: Classes
```{r, include=TRUE}
createTreatmentPlotClasses(dataCS)
```

## Treatment Breakdown: Book Price Comparison
```{r, include=TRUE}
createTreatmentPlotClassesPriceDiff(dataCS)
```

## Treatment Breakdown: Clean Sample Class in Student Major 
```{r, include=TRUE}
createTreatmentPlotMajorClass(dataCS)
```

## Treatment Breakdown: Clean Sample Students' Freshman Status
```{r, include=TRUE}
createTreatmentPlotFreshman(dataCS)
```

# Summary Statistics Plot for Loose Joined Data
...
## General Treatment Breakdown
```{r, include=TRUE}
createTreatmentPlot(dataJoinedLoose)
```

## Treatment Breakdown: Classes
```{r, include=TRUE}
createTreatmentPlotClasses(dataJoinedLoose)
```

## Treatment Breakdown: Book Price Comparison
```{r, include=TRUE}
createTreatmentPlotClassesPriceDiff(dataJoinedLoose)
```

## Treatment Breakdown: Clean Sample Class in Student Major 
```{r, include=TRUE}
createTreatmentPlotMajorClass(dataJoinedLoose)
```

## Treatment Breakdown: Clean Sample Students' Freshman Status
```{r, include=TRUE}
createTreatmentPlotFreshman(dataJoinedLoose)
```

# Summary Statistics Plot for Looser Joined Data
...
## General Treatment Breakdown
```{r, include=TRUE}
createTreatmentPlot(dataJoinedLooser)
```

## Treatment Breakdown: Classes
```{r, include=TRUE}
createTreatmentPlotClasses(dataJoinedLooser)
```

## Treatment Breakdown: Book Price Comparison
```{r, include=TRUE}
createTreatmentPlotClassesPriceDiff(dataJoinedLooser)
```

## Treatment Breakdown: Clean Sample Class in Student Major 
```{r, include=TRUE}
createTreatmentPlotMajorClass(dataJoinedLooser)
```

## Treatment Breakdown: Clean Sample Students' Freshman Status
```{r, include=TRUE}
createTreatmentPlotFreshman(dataJoinedLooser)
```
